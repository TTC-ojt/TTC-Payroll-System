...
{
    public partial class PayrollSummaryTeachers1 : Form
    {
        public PayrollSummaryTeachers1()
        {
            InitializeComponent();
        }
        ...
        public void NewSet()
        {
            ...
            {
                if (employee.department_id != 4) continue;
        ...
        private void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            {
                dgvPayroll1.SelectAll();
                DataObject dataObj = dgvPayroll1.GetClipboardContent();
                if (dataObj != null)
